//
// reversedScatteredLineBrush.cpp
//
...
ReversedScatteredLineBrush::ReversedScatteredLineBrush(ImpressionistDoc* pDoc, char* name) :
	ImpBrush(pDoc, name)
{
}

void ReversedScatteredLineBrush::BrushBegin(const Point source, const Point target)
{
...
void ReversedScatteredLineBrush::BrushMove(const Point source, const Point target)
{
	ImpressionistDoc* pDoc = GetDocument();
	ImpressionistUI* dlg = pDoc->m_pUI;
...
void ReversedScatteredLineBrush::BrushEnd(const Point source, const Point target)
{
	// do nothing so far
	glDisable(GL_BLEND);
